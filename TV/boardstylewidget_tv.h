#ifndef BoardStyleWidgetTv_H
#define BoardStyleWidgetTv_H
...
class QPushButton;
class QLineEdit;
class BoardStyleWidgetTv : public QWidget
{
    Q_OBJECT
public:
    explicit BoardStyleWidgetTv(QWidget *parent = nullptr,QString boardName="");
private:
